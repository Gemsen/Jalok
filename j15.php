...
echo color("red","!] Klaim Voucher?(Y/N) ");
        ...
        $code1 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAUGOFOOD0508"}');
	...
	gocar:
        ...
        $code1 = request6('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAUGOFOOD0508"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","+] Message: ".$message);
        sleep(1);
